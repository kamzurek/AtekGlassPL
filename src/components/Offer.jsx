...
export default function Offer() {
    const offers = [
        ...
        { title: 'Szkło z grafiką 3D (panele szklane)', icon: '🔍', description: 'Nowoczesne panele z grafiką UV, idealne jako lustra ścienne, szkło kuchenne czy dekoracyjne.' },
        { title: 'Balustrady szklane', icon: '🔍', description: 'Eleganckie balustrady z hartowanego szkła do balkonów, tarasów i wnętrz.' },
        { title: 'Kabiny prysznicowe', icon: '🔍', description: 'Gotowe i na wymiar kabiny z bezpiecznego szkła hartowanego, z opcjami drzwiczek przesuwnych i stałych.' },
